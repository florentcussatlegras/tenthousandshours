...
export default function CurrentStudySessionDeleteLayout({
  ...
  return (
    <section className="flex flex-col items-start gap-6 py-8 md:py-10 max-w-[1536] mx-auto">
      ...
      <h1 className="text-3xl font-bold text-default-600">Valider votre session de travail en <span className="text-sky-500">{localStorage.getItem('current_study_session_topic_name')}</span></h1>
